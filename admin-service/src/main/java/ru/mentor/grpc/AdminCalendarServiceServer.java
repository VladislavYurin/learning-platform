...
public class AdminCalendarServiceServer extends AdminCalendarServiceImplBase {
    ...
    public void getAllTimeSlots(
        ...
        log.info(
                "[ RqUId = {} ] Поступил запрос  на получение страницы слотов с номером [{}] размером [{}] от администратора",
                requestId,
