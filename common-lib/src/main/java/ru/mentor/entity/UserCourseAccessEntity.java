...
public class UserCourseAccessEntity {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "user_course_access_seq")
    @SequenceGenerator(name = "user_course_access_seq", sequenceName = "user_course_access_seq", allocationSize = 1)
