...
public interface MentorTagMapperReactive {
    ...
    default AttachMentorTagsResponse toAttachMentorTagsResponse(String rqUid, List<Long> attachedTagsIds, List<Long> didntAttachedIds) {
    ...
    default AttachMentorTagsRequest toAttachMentorTagsRequest(MentorTagsAttachRequestDto requestDto, Header header){
    ...
    default DetachMentorTagRequest toDetachMentorTagRequest(MentorTagDetachRequestDto dettachRequestDto, Header header){
    ...
    default CreateCustomMentorTagRequest toCreateCustomMentorTagRequest (MentorTagDtoCreateRequest createRequest, Header header) {
