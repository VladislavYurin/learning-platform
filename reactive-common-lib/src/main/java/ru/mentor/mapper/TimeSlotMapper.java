...
public interface TimeSlotMapper {
    ...
    @Mapping(target = "createdAt", source = "timeSlotEntity.createdAt",
            qualifiedByName = "localDateTimeToTimestamp")
    TimeSlotResponse toTimeSlotResponse(MentorTimeSlotEntity timeSlotEntity,
                                        String requestId);

    default MentorSlotInfo mentorTimeSlotEntityToMentorSlotInfo(
    ...
    default List<MentorSlotInfo> mapMentorTimeSlotEntityPageToMentorSlotInfoList(
            Page<MentorSlotInfo> mentorTimeSlotEntityPage) {
