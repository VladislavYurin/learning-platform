...
public class EntityNotFoundException extends RuntimeException {
    ...
    /**
     * Создает новое исключение EntityNotFoundException с указанным сообщением и идентификатором
     * запроса.
     *
     * @param message
     *         сообщение об ошибке
     ...
     */
    public EntityNotFoundException(String message, String requestId) {
        super(message);
