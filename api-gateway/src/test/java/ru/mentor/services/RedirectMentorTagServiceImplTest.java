...
import ru.mentor.services.impl.RedirectMentorTagServiceImpl;

@ExtendWith(MockitoExtension.class)
public class RedirectMentorTagServiceImplTest {
    @Mock
    private MentorTagsGrpcClient grpcClient;
    ...
    @InjectMocks
    private RedirectMentorTagServiceImpl service;
