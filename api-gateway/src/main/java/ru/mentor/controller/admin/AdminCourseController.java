...
class AdminCourseController {
     ...
     *
     * @param pageSettings
     *         объект настроек страницы (номер страницы и размер)
     *
    ...
    @GetMapping("/all")
    public ResponseEntity<Page<CourseDto>> getAllCourses(@RequestBody PageSettings pageSettings) {
        return ResponseEntity.ok().body(redirectAdminCourseService.getAllCourses(pageSettings));
    }
