...
public interface AccessMapper {
    ...
    GetAccessRequest toGetAccessRequest(UserEntity user, CourseAccessRequest request);

    @Mapping(target = "mentorId", source = "user.id")
    @Mapping(target = "userId", source = "request.userId")
    @Mapping(target = "courseId", source = "request.courseId")
    @Mapping(target = "moduleId", source = "request.moduleId")
    GetAccessRequest toGetAccessRequest(UserEntity user, ModuleAccessRequest request);
