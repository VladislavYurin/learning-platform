...
/**
 * DTO для запроса создания нового модуля курса.
 * Содержит всю необходимую информацию для создания модуля,
 * включая привязку к курсу, порядковый номер и содержимое.
 * 
...
public class CreateModuleRequest {
    ...
    /**
     * Название модуля.
     * Должно быть описательным и отражать содержание модуля.
     */
     ...
     * Определяет последовательность изучения модулей.
     */
     ...
     * Включает теоретический материал, примеры кода и задания.
     */
